...
## 0.23.0-rc1
**Full Changelog**: https://github.com/ngrok/ngrok-operator/compare/helm-chart-ngrok-operator-0.22.2...helm-chart-ngrok-operator-0.23.0-rc1

- Update ngrok-operator image version to `0.21.0-rc1`
- Update Helm chart version to `0.23.0-rc1`
- Update [ngrok-crds](../ngrok-crds/CHANGELOG.md) dependency version to `0.3.0-rc1`
