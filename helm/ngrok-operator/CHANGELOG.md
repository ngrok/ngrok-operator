...
- Update ngrok-operator image version to `0.22.0-rc.2`
- Update Helm chart version to `0.24.0-rc.2`
- Update [ngrok-crds](../ngrok-crds/CHANGELOG.md) dependency version to `0.4.0-rc.2`

### Fixed
- Picks up the container fixes in [`0.22.0-rc.2`](../../CHANGELOG.md#0220-rc2) (rollback-safe `enabledFeatures` dual-write and the `ngrok/v2` connection-leak downgrade) by @alex-bezek in [#865](https://github.com/ngrok/ngrok-operator/pull/865), [#866](https://github.com/ngrok/ngrok-operator/pull/866)
...
### Breaking Changes
- Removed default resource requests from the cleanup hook helm values to follow chart conventions by @alex-bezek in [#839](https://github.com/ngrok/ngrok-operator/pull/839)
- Tightened operator RBAC further and updated the RBAC specs by @alex-bezek in [#844](https://github.com/ngrok/ngrok-operator/pull/844)
...
- Update ngrok-operator image version to `0.20.3`
- Update Helm chart version to `0.22.2`

### Removed
- Removed the deprecated `useExperimentalGatewayApi` helm value. Use `gateway.enabled` instead by @sabrina-ngrok in [#778](https://github.com/ngrok/ngrok-operator/pull/778)
...
- Update ngrok-operator image version to `0.20.1`
...
- fix(helm): Add missing RBAC `update` permission on Domains for the agent manager ClusterRole so the agent endpoint controller can add controller labels to existing Domain CRs by @alex-bezek in [#762](https://github.com/ngrok/ngrok-operator/pull/762)

## 0.22.0-rc.3
**Full Changelog**: https://github.com/ngrok/ngrok-operator/compare/helm-chart-ngrok-operator-0.22.0-rc.2...helm-chart-ngrok-operator-0.22.0-rc.3

- Update ngrok-operator image version to `0.20.1`
- Update Helm chart version to `0.22.0-rc.3`
