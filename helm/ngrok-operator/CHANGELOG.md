...
## 0.22.0-rc.2
**Full Changelog**: https://github.com/ngrok/ngrok-operator/compare/helm-chart-0.21.1...helm-chart-0.22.0-rc.2
...
- fix(agents): Missing frontmatter header by @jonstacks in [#757](https://github.com/ngrok/ngrok-operator/pull/757)
