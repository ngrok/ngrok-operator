...
| `deploymentTerminationWatcher.enabled`             | When true, the operator will watch for its own deployment(s) being terminated and will begin shutdown procedures when detected | `false`                                   |
