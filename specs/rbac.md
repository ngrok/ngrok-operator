...
| domains/finalizers | ingress.k8s.ngrok.com | update | Domain controller |
...
| ippolicies/finalizers | ingress.k8s.ngrok.com | update | IPPolicy controller |
...
| boundendpoints/finalizers | bindings.k8s.ngrok.com | update | BoundEndpoint controller |
...
| agentendpoints/finalizers | ngrok.k8s.ngrok.com | update | AgentEndpoint lifecycle |
...
| cloudendpoints/finalizers | ngrok.k8s.ngrok.com | update | CloudEndpoint controller |
...
| kubernetesoperators/finalizers | ngrok.k8s.ngrok.com | update | KubernetesOperator controller |
...
| ngroktrafficpolicies/finalizers | ngrok.k8s.ngrok.com | update | NgrokTrafficPolicy controller |
...
| agentendpoints/finalizers | ngrok.k8s.ngrok.com | update | AgentEndpoint finalizer |
...
```bash
# Dump effective permissions per SA
kubectl auth can-i --list \
  --as=system:serviceaccount:<ns>:<sa-name> \
  -n <ns>
```

Compare against the baseline dumps in `specs/rbac/baseline/`.
