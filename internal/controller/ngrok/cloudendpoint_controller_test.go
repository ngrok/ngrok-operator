...
// NOTE: This test is now obsolete as domain logic has been refactored to the domain manager package.
// Domain-related functionality is tested in internal/controller/domain/manager_test.go
