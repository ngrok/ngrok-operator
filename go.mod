...
// POC: the Endpoint.kubernetes projection field is not released yet. Points at
// the ngrok-api-go branch alex/endpoint-kubernetes-projection. Drop this once
// the field ships in a tagged ngrok-api-go release.
replace github.com/ngrok/ngrok-api-go/v9 => github.com/ngrok/ngrok-api-go/v9 v9.0.1-0.20260909231000-150bdadfdc64
