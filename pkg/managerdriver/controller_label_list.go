// LEGACY-PREFIX-MIGRATION: BEGIN (file scope — delete this whole file in 1.0)
...
//
// call at each callsite. Delete this file and re-inline the single List
// in driver.go::Sync and endpoints.go::SyncEndpoints in the cleanup PR.
